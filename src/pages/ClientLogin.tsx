...
const ClientLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-background dark:from-blue-950 dark:to-background flex items-center justify-center px-4 py-12">
      <Card className="w-full max-w-[420px] border border-border shadow-lg">
        <CardContent className="p-8 space-y-6">
          <div className="flex flex-col items-center space-y-3">
            <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-portal-blue to-blue-600 flex items-center justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-sm text-portal-blue hover:underline">
                Forgot password?
              </Link>
            </div>
            ...
            <Button
              type="submit"
              className="w-full h-11 bg-portal-blue hover:bg-portal-blue/90 text-white font-semibold"
